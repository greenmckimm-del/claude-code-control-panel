/**
 * mountain.js — Generative mountain scene for hero background.
 * Light theme: soft indigo mesh on white/slate hero.
 * Ported from Three.js React component to vanilla JS.
 */
...
(function () {
  ...
  function initMountainScene() {
    const mount = document.getElementById('mountain-canvas');
    ...
    // Light theme: soft indigo (#a5b4fc) instead of sky-blue
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        color: { value: new THREE.Color('#a5b4fc') }, // indigo-300
      },
      vertexShader: `
        uniform float time;
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          // Light theme: lower opacity so the white hero shows through
    ...
    // Cleanup on page unload (not strictly needed for static site but good practice)
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initMountainScene);
  } else {
    initMountainScene();
  }
})();
